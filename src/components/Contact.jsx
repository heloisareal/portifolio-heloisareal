...
const Contact = () => {
    return(
        ...
        id="contact"
        >
            <div className="container mt-10 lg:grid lg:grid-cols-2 lg:items-stretch mb-10">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                       Mande uma mensagem para mim! Com certeza irei recebê-la e terei muito prazer em ler.
                    </p>
                ...
                <form 
                    action="https://getform.io/f/ayvplklb"
                    method="POST"
                        ...
                        <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                            ...
                            <div className="mb-4">
                                ...
                                <input 
                                    ...
                                    autoComplete="email"
                                    required
                                    placeholder="heloisareal17@gmail.com"
                                    className="text-field reveal-up"
                                />
                            </div>
